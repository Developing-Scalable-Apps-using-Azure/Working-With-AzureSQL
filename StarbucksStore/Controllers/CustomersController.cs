...
namespace StarbucksStore.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ibdbContext context, IDistributedCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var cachedCustomers = _cache.GetString("starbucksCustomers");

            if(!string.IsNullOrEmpty(cachedCustomers))
            {
                customers = JsonConvert.DeserializeObject<List<Customer>>(cachedCustomers);
            }
            else
            {
                customers = _context.Customers.ToList();
                _cache.SetString("starbucksCustomers", JsonConvert.SerializeObject(customers));
            }
